...
public class Student extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       int selectedIndex = jTable2.getSelectedRow();
        try {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/sms","root","");
            insert = con1.prepareStatement("update student set name= ?,classes= ?,rollno= ?,address= ?,mobno =?,email= ? where id= ?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/sms","root","");
            insert = con1.prepareStatement("insert into student(name,classes,rollno,address,mobno,email)values(?,?,?,?,?,?)");
            insert.setString(1,name);
            insert.setString(2,classes);
            insert.setString(3,rollno);
            insert.setString(4,address);
